...
public class GvrEye : MonoBehaviour {
  ...
  /// <summary>
  /// By default the monoscopic skybox is copied from the parent camera on the 
  /// StereoController. Enable this option if you want a custom skybox on each 
  /// GvrEye to be left as-is (for example if you have a stereo pair of skyboxes 
  /// where one eye gets the left or right skybox, use this)
  /// </summary>
  public bool keepCustomSkybox = false;
